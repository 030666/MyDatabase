...
> ```
> ![在这里插入图片描述](https://img-blog.csdnimg.cn/bb83d04d47644af6ac7d15002367a568.png)
>
...
> ```
>
> ![在这里插入图片描述](https://img-blog.csdnimg.cn/25377bbe3e114c98a00edfd4c30a7c3b.png)
> 还可以使用下划线来表示任意字符，比如我想要找到第三个字符是b的国家：
> ```sql
> SELECT * FROM covid_month WHERE Country LIKE '__b%';
> ```
> ![在这里插入图片描述](https://img-blog.csdnimg.cn/05896f609a144b258487378a0e98a14f.png)
> ==注意：==
...
>
> ![在这里插入图片描述](https://img-blog.csdnimg.cn/66a32ff025754dafa420d12a1e92f870.png)
> ## 5.2 两个表做并集
...
> ```
> ![在这里插入图片描述](https://img-blog.csdnimg.cn/46102d031d3b4e68bdff39dfcd61c66a.png)
> 这样的话国家名称是不会重复的，如果在UNION后面加上ALL就不会去重
> ![在这里插入图片描述](https://img-blog.csdnimg.cn/5bc9e2e54ded440f80ac4c07d3ff683e.png)